      ...
      <div className="space-y-4">
        <div className="card p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold text-ink-900">Account</h3>
        ...
        <div className="card p-6">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-ink-500">Email me about requests, payments and complaints</p>
            </div>
            <label className="relative inline-flex cursor-pointer items-center">
              <input type="checkbox" defaultChecked className="peer sr-only" />
              <div className="h-6 w-11 rounded-full bg-ink-200 after:absolute after:left-0.5 after:top-0.5 after:h-5 after:w-5 after:rounded-full after:bg-white after:transition peer-checked:bg-brand-600 peer-checked:after:translate-x-5" />
            </label>
          </div>
        </div>
        ...
        <div className="card p-6">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-ink-500">Light theme (default)</p>
            </div>
          </div>
        </div>
        ...
        <div className="card border-red-100 p-6">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="font-semibold text-ink-900">Sign out</h3>
              <p className="text-sm text-ink-500">Log out of your RentConnect account</p>
            </div>
